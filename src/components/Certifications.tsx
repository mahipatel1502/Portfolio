      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className={`backdrop-blur-sm p-6 rounded-xl border transition-all hover:shadow-lg ${
                isDark
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="bg-gradient-to-br from-cyan-400 to-blue-500 w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <p className={`text-sm mb-3 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>{cert.description}</p>
